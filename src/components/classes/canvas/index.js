export default class Canvas {
    ...
    setup() {
        ...
        this.shader.setUniform('u_glowintensity', 10);
        this.shader.setUniform('u_width', this.sketch.width / 1.5 < 370 ? this.sketch.width / 1.5 : 500);
        this.shader.setUniform('u_coloring', .5);
        this.shader.setUniform('u_speed', .1);
        this.shader.setUniform('u_circ', .05);
        this.shader.setUniform('u_step', .2);
    }
